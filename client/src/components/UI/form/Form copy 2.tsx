...
import { BannerSchema } from "../../../pages/banners/config";
                        ...
                        <Controller
                          ...
                          render={({ field }) => (
                            <>
                              <Input
                                {...field}
                                className={errors[key] && styles.fieldError}
                                // ref={null}
                                // control={control}
                                // name={key}
                                // value={
                              ...
                              />
                              {errors[key] ? (
                                <span>{errors[key]?.message as string}</span>
                              ) : null}
                            </>
                          )}
                        />
